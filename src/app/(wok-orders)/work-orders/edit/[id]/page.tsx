...
export default function EditWorkOrder() {
            ...
            const fetchWorkOrder = async () => {
                try {
                    ...
                    if (data.asset_id) {
                        ...
                        const asset = assets.find((a: Asset) => a.id === data.asset_id.toString());
    ...
    const handleServiceCardFieldChange = (index: number, field: keyof ServiceCard, value: string | number) => {
